            ...
            <div class="row gy-5 gy-lg-0 align-items-center justify-content-center justify-content-lg-between">
                <div class="col-12 col-lg-7 col-xxl-6">
                    <div class="section__content">
                        <span class="section__content-sub-title headingFour wow fadeInDown" data-wow-duration="0.8s"><img
                                src="assets/images/title_vector.png" alt="vector">
                            Simplify Your Loan Search and Save Time</span>
                        <h1 class="section__content-title display-3 wow fadeInUp" data-wow-duration="1s">Explore Your
                            Loan Options with Ease</h1>
                        <p class="section__content-text wow fadeInDown" data-wow-duration="0.8s">We understand that
                            finding the right loan can be overwhelming. That's why we're here to help simplify the
                            process</p>
                ...
                <div class="col-12 col-md-9 col-lg-5 col-xxl-5">
                    <div class="hero--secondary__thumb wow fadeInUp" data-wow-duration="0.8s">
                        <img src="assets/images/hero_img2.png" alt="Image">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center justify-content-lg-between gy-5 gy-lg-0">
                <div class="col-12 col-sm-8 col-lg-6 col-xxl-5 order-1 order-lg-0">
                    <div class="how-works__thumbs previewShapeY unset-xxl-left me-4 me-xxl-0 wow fadeInDown"
                        data-wow-duration="0.8s">
                        <img src="assets/images/choose_us2.png" alt="image">
                    </div>
                </div>
                <div class="col-12 col-lg-6 col-xxl-6">
                    <div class="section__content">
                        <span class="section__content-sub-title headingFour wow fadeInDown" data-wow-duration="0.8s"><img
                                src="assets/images/title_vector.png" alt="vector">Why
                            Choose Us</span>
                        <h2 class="section__content-title wow fadeInUp" data-wow-duration="0.8s">Unlocking
                            Opportunities for Your Success Loan Solutions</h2>
                        <p class="section__content-text wow fadeInDown" data-wow-duration="0.8s">Our dedicated team of
                            experts conducts thorough research and analysis to provide you with comprehensive and
                            unbiased reviews of various loan options.</p>
                        <div class="section__content-inner">
                            <div class="card wow fadeInDown" data-wow-duration="0.8s">
                                ...
                                <div class="card__content">
                                    <h4 class="card__title">Minimum documents required for loans.</h4>
                                    <p class="fs-small">We prioritize your satisfaction. Our dedicated customer service
                                        team is ready to assist</p>
                                </div>
                            </div>
                            <div class="card wow fadeInDown" data-wow-duration="0.8s">
                                <div class="card__icon">
                                ...
                                <div class="card__content">
                                    <h4 class="card__title">Consider agriculture/cash income</h4>
                                    <p class="fs-small">We have established strong partnerships with a wide network of
                                        reputable lenders</p>
                                </div>
                            </div>
                            <div class="card wow fadeInDown" data-wow-duration="0.8s">
                                ...
                                <div class="card__content">
                                    <h4 class="card__title">Get loan sanctioned in 3-4 working days</h4>
                                    <p class="fs-small">Transparency and objectivity are at the core of our values. Our
                                        platform provides unbiased</p>
                                </div>
                            </div>
                            <div class="card wow fadeInDown" data-wow-duration="0.8s">
                                <div class="card__icon">
                                    <svg width="36" height="36" viewBox="0 0 36 36" fill="none"
                                        ...
                                        <g clip-path="url(#clip0_1092_7390)">
                                            <path
                                                ...
                                                stroke="#074C3E" stroke-miterlimit="10" stroke-linecap="round"
                                ...
                                <div class="card__content">
                                    <h4 class="card__title">Get loan disbursement in limited period</h4>
                                    <p class="fs-small">Our team consists of financial experts with deep industry
                                        knowledge</p>
                                </div>
                            </div>
                        </div>
                        {{-- <a href="loan-reviews.html" class="btn_theme btn_theme_active d-inline-flex mt_40 wow fadeInDown"
                            data-wow-duration="0.8s">Read More<i class="bi bi-arrow-up-right"></i><span></span></a> --}}
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12 col-lg-6 col-xxl-5">
                    <div class="section__header">
                        <span class="section__header-sub-title headingFour wow fadeInDown" data-wow-duration="0.8s"><img
                                src="assets/images/title_vector.png" alt="vector">Client
                            Testimonials</span>
                        <h2 class="section__header-title wow fadeInUp" data-wow-duration="0.8s">Success Stories Shared
                            by Our Customers</h2>
                        <p class="section__header-content wow fadeInDown" data-wow-duration="0.8s">Feel free to
                    ...
                    <div class="section__header">
                        <span class="section__header-sub-title headingFour wow fadeInDown" data-wow-duration="0.8s"
                            style="visibility: visible; animation-duration: 0.8s; animation-name: fadeInDown;"><img
                                src="assets/images/title_vector.png" alt="vector"> Our Services</span>

                        <p class="section__header-content wow fadeInDown" data-wow-duration="0.8s"
                            style="visibility: visible; animation-duration: 0.8s; animation-name: fadeInDown;">We are
                            dedicated to providing you with valuable services that simplify your loan search and empower you
                            to make informed borrowing decisions. Our comprehensive range of services</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4">
                    <a href="{{ route('personal') }}">
                        <div class="card card--custom slick-slide slick-cloned" id="" aria-hidden="true"
                            tabindex="-1">
                            <div class="card__icon">
            ...
            <div class="row align-items-center justify-content-center justify-content-lg-between gy-5 gy-lg-0">
                <div class="col-12 col-sm-8 col-lg-6 col-xxl-5 order-1 order-lg-0">
                    <div class="how-works__thumbs unset-xxl-left me-4 me-xxl-0 wow fadeInDown" data-wow-duration="0.8s">
                        <img src="assets/images/how_works.png" alt="image">
                    </div>
                </div>
                <div class="col-12 col-lg-6 col-xxl-6">
                    <div class="section__content">
                        <span class="section__content-sub-title headingFour wow fadeInDown" data-wow-duration="0.8s"><img
                                src="assets/images/title_vector.png" alt="vector">How It
                            Works</span>
                        <h2 class="section__content-title wow fadeInUp" data-wow-duration="0.8s">Fast & Easy Application
                            Process.
                        </h2>
                        <p class="section__content-text wow fadeInDown" data-wow-duration="0.8s">The goal is to
                            provide a clear and concise overview of how your platform works and guide users through the
                            loan application journey.</p>
                        <div class="section__content-inner mt_60">
                            <div class="card wow fadeInUp" data-wow-duration="0.8s">
                                ...
                                <div class="card__content">
                                    <h4 class="card__title">Apply Now</h4>
                                    <p class="fs-small">Apply For Loan.</p>
                                </div>
                            </div>
                            <div class="card wow fadeInUp" data-wow-duration="0.8s">
                                <div class="card__icon">
                                ...
                                <div class="card__content">
                                    <h4 class="card__title">Choose Loan Amount & Type
                                    </h4>
                                    <p class="fs-small">Enter the loan amount and type
                                    </p>
                                </div>
                            </div>
                            <div class="card wow fadeInUp" data-wow-duration="0.8s">
                                ...
                                <div class="card__content">
                                    <h4 class="card__title">Get loan sanctioned and disbursement into your account.</h4>
                                    <p class="fs-small">Get your money in minutes.
                ...
                <div class="col-12 col-lg-7 col-xxl-6">
                    <div class="section__header">
                        ...
                        <h2 class="section__header-title wow fadeInUp" data-wow-duration="0.8s">Find Answers to Common
                            Questions</h2>
                        <p class="section__header-content wow fadeInDown" data-wow-duration="0.8s">We've compiled a
                            list of frequently asked questions to provide you with quick and helpful answers. If you
                            have a question that is not addressed below</p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12 col-lg-10 col-xxl-8">
                    <div class="accordion wow fadeInDown" data-wow-duration="0.8s" id="faq">
                        <div class="accordion-item accordion_bg">
                            <h5 class="accordion-header">
                                <button class="accordion-button " type="button" data-bs-toggle="collapse"
                                    data-bs-target="#faq-accordion-1" aria-expanded="true"
                            ...
                            <div id="faq-accordion-1" class="accordion-collapse collapse show" data-bs-parent="#faq">
                                <div class="accordion-body">
                                    <p class="mb-0">
                                        Absolutely. We strive to provide reliable and up-to-date information. Our team
                                        follows strict editorial guidelines to ensure the accuracy and integrity of our
                                        content. However,
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="accordion-item">
                            <h5 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#faq-accordion-2" aria-expanded="true"
                        ...
                        <div class="accordion-item">
                            <h5 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#faq-accordion-3" aria-expanded="true"
                        ...
                        <div class="accordion-item">
                            <h5 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#faq-accordion-4" aria-expanded="true"
                        ...
                        <div class="accordion-item">
                            <h5 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#faq-accordion-5" aria-expanded="true"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body p-4 pb-5">
                    ...
                    <p class="mt-5" id="candidate_desc">I started my education loan process in the month of January.
                        After trying out
