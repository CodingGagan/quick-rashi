                                    ...
                                    <fieldset>
                                        <div class="form-card">
                                            <div class="row">
                                                ...
                                                class="fieldlabels">Username: *</label> <input type="text" name="uname"
                                                placeholder="UserName" /> <label class="fieldlabels">Password: *</label>
                                            <input type="password" name="pwd" placeholder="Password" /> <label
                                                class="fieldlabels">Confirm Password: *</label> <input type="password"
                                    ...
                                    <fieldset>
                                        <div class="form-card">
                                            <div class="row">
                                                ...
                                                class="fieldlabels">Upload Signature Photo:</label> <input type="file"
